...
class HomeController extends Controller
{
    public function index() {
        ...
        $properties = Property::where('user_id', $userId)->get()->load('multimedia');
    ...
    public function upload(Request $request, $id) {
        ...
        $property = Property::with('multimedia')->findOrFail($id); // Asegúrate de tener una relación 'multimedia' definida en tu modelo Property
    ...
    {
        $property = Property::with('multimedia')->findOrFail($id);
