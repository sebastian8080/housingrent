        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link call-btn" href="tel:+593987595789">098-759-5789</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <section class="container">
            <div class="row p-5 border-bottom border-white border-3">
                ...
                <div class="col-sm-2 text-white">
                    ...
                    <div>
                        <p class="m-0">
                            <a href="tel:+593987595789" class="asindeco" style="color: #ffffff !important; text-decoration: none"><i class="fa-solid fa-phone text-white"></i> 
                                098-759-5789
                            </a>
                        </p>
                        <p class="m-0">
